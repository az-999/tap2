            ...
            <article class="main__content-item main__content-form col col-xl-8">
               ...
               <div class="main__content-item-section">
                  <div class="row">
                   ...
                   <div class="row">
                       <div class="col-lg-4">
                           <a href="/dashboard/task-list?sort=id&order=desc" class="btn btn-light " style="width: 100%;">All</a>
                       </div>
                       <div class="col-lg-4">
                           <a href="/dashboard/task-list-kols?sort=id&order=desc" class="btn btn-primary " style="width: 100%;">KOLs</a>
                       </div>
                       <div class="col-lg-4">
                  ...
                  <table class='table table-striped align-middle table-bordered' style="font-family: Gilroy, sans-serif">
