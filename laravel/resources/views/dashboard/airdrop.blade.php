            ...
            <article class="main__content-item main__content-form col col-xl-8">
               ...
               <div class="main__content-item-section">
                  <div class="row">
                   ...
                   <a href="/dashboard/airdrop-task-add" class="btn btn-primary">Add</a>
                   <a href="/dashboard/airdrop-request-list" class="btn btn-primary">Request List</a>
                  ...
                  <table class='table table-striped align-middle table-bordered'
                     ...
                     <thead class='align-middle text-center'>
                        <tr>
                           <?php
                           $query = \App\Models\AirdropTask::query()
                           ;
                     ...
                     <tbody>
                        ...
                        <tr>
                           <th scope="row"><a href="/dashboard/airdrop-task-edit?id={{$task->id}}">{{$task->id}}</a></th>
                           <td><?php
                           if ($task->partner_id) {
