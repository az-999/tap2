    ...
    */
    'bots' => [
        'mybot' => [
            ...
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', '/application/ssl/YOURPUBLIC.pem'),
            'webhook_url'      => env('TELEGRAM_WEBHOOK_URL', 'https://api.mmbump.pro/telegram/webhook'),
            /*
             * @see https://core.telegram.org/bots/api#update
             */
            'allowed_updates'  => null,
            'name'             => env('TELEGRAM_NAME', 'MMproBump_bot'),
            'commands'         => [
                //Acme\Project\Commands\MyTelegramBot\BotCommand::class
            ],
        ],
        'admin' => [
            'token'            => env('TELEGRAM_ADMIN_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path' => env('TELEGRAM_ADMIN_CERTIFICATE_PATH', '/application/ssl/YOURPUBLIC.pem'),
            'webhook_url'      => env('TELEGRAM_ADMIN_WEBHOOK_URL', 'https://api.mmbump.pro/telegram/webhook'),
            /*
             * @see https://core.telegram.org/bots/api#update
             */
            'allowed_updates'  => null,
            'name'             => env('TELEGRAM_ADMIN_BOT_NANE', 'MMproBump_admin_bot'),
            'commands'         => [
                //Acme\Project\Commands\MyTelegramBot\BotCommand::class
            ],
        ],
