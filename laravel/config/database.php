    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'url'            => env('DATABASE_URL'),
            'read' => [
                'host' => explode(',', env('DB_READ_HOST_LIST', '127.0.0.1')),
            ],
            'write' => [
                'host' => env('DB_WRITE_HOST', '127.0.0.1'),
            ],
            'port'           => env('DB_PORT', '3306'),
            'database'       => env('DB_DATABASE', 'tap-log'),
        ...
        'mysql_log' => [
            ...
            'read' => [
                'host' => explode(',', env('DB_LOG_READ_HOST_LIST', '127.0.0.1')),
            ],
            'write' => [
                'host' => env('DB_LOG_WRITE_HOST', '127.0.0.1'),
            ],
