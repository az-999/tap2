...
const StakingBg = () => {
  return (
    <svg
      ...
      id="staking-bg-icon"
    >
      <g filter="url(#filter0_di_5565_9770)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_5565_9770"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_5565_9770"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect2_innerShadow_5565_9770"
          />
        </filter>
      </defs>
    </svg>
