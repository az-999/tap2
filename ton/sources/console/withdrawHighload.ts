import { Address, beginCell, external, internal, SendMode, storeMessage, TonClient4, WalletContractV4 } from "@ton/ton";
import { mnemonicToPrivateKey } from "ton-crypto";
import { HighloadWalletContractV2 } from "../output/wallet/HighloadWalletV2";

export const withdrawHigload = async (client4: TonClient4, dest: string, value: string) => {
