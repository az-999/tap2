...
## MintManyByOwner
TLB: `mint_many_by_owner#5fcc3d15 mint_to:address count:uint32 contents:dict<int, ^cell> = MintManyByOwner`
Signature: `MintManyByOwner{mint_to:address,count:uint32,contents:dict<int, ^cell>}`

## SetSecondMinter
TLB: `set_second_minter#ada3c07b new_second_minter_address:address = SetSecondMinter`
Signature: `SetSecondMinter{new_second_minter_address:address}`
...
## ChangeTrustedAddress
TLB: `change_trusted_address#bf7bb024 new_trusted_address:address = ChangeTrustedAddress`
Signature: `ChangeTrustedAddress{new_trusted_address:address}`
...
7031: Only owner can set second minter
17078: Only owner can change trusted address
