...
function dictValueParserMintManyByOwner(): DictionaryValue<MintManyByOwner> {
    return {
        serialize: (src, buidler) => {
            buidler.storeRef(beginCell().store(storeMintManyByOwner(src)).endCell());
        },
        parse: (src) => {
...
function dictValueParserTransferTON(): DictionaryValue<TransferTON> {
 ...
 type Module_init_args = {
    $$type: 'Module_init_args';
    collection_address: Address;
    item_index: bigint;
}

function initModule_init_args(src: Module_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.collection_address);
...
async function Module_init(collection_address: Address, item_index: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initModule_init_args({ $$type: 'Module_init_args', collection_address, item_index })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const Module_errors: { [key: number]: { message: string } } = {
...
const Module_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"typed","type":"ChangeTrustedAddress"}},
]

export class Module implements Contract {
    
    static async init(collection_address: Address, item_index: bigint) {
        return await Module_init(collection_address, item_index);
    }
    
    static async fromInit(collection_address: Address, item_index: bigint) {
        const init = await Module_init(collection_address, item_index);
        const address = contractAddress(0, init);
        return new Module(address, init);
    }
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Destroy | Transfer | GetStaticData | ChangeTrustedAddress) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ChangeTrustedAddress') {
            body = beginCell().store(storeChangeTrustedAddress(message)).endCell();
        }
