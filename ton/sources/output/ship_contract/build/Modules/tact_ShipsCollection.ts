...
export type ShipsCollection$Data = {
    $$type: 'ShipsCollection$Data';
    next_item_index: bigint;
    owner_address: Address;
...
export function storeShipsCollection$Data(src: ShipsCollection$Data) {
    return (builder: Builder) => {
        let b_0 = builder;
...
export function loadShipsCollection$Data(slice: Slice) {
    let sc_0 = slice;
    ...
    return { $$type: 'ShipsCollection$Data' as const, next_item_index: _next_item_index, owner_address: _owner_address, royalty_params: _royalty_params, collection_content: _collection_content, collection_base: _collection_base, unique_nonce: _unique_nonce, TOTAL_SUPPLY: _TOTAL_SUPPLY, treasury_address: _treasury_address };
}

function loadTupleShipsCollection$Data(source: TupleReader) {
    let _next_item_index = source.readBigNumber();
    let _owner_address = source.readAddress();
...
function loadGetterTupleShipsCollection$Data(source: TupleReader) {
    let _next_item_index = source.readBigNumber();
    let _owner_address = source.readAddress();
    const _royalty_params_p = source.readTupleOpt();
    const _royalty_params = _royalty_params_p ? loadTupleRoyaltyParams(_royalty_params_p) : null;
...
function storeTupleShipsCollection$Data(source: ShipsCollection$Data) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.next_item_index);
    builder.writeAddress(source.owner_address);
...
function dictValueParserShipsCollection$Data(): DictionaryValue<ShipsCollection$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeShipsCollection$Data(src)).endCell());
        },
        parse: (src) => {
            return loadShipsCollection$Data(src.loadRef().beginParse());
        }
    }
}
...
export function storeModule$Data(src: Module$Data) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.collection_address);
...
export function loadModule$Data(slice: Slice) {
    let sc_0 = slice;
    let _collection_address = sc_0.loadAddress();
    ...
    return { $$type: 'Module$Data' as const, collection_address: _collection_address, item_index: _item_index, is_initialized: _is_initialized, trusted_address: _trusted_address, owner: _owner, individual_content: _individual_content };
}

function loadTupleModule$Data(source: TupleReader) {
    let _collection_address = source.readAddress();
...
function loadGetterTupleModule$Data(source: TupleReader) {
    let _collection_address = source.readAddress();
    let _item_index = source.readBigNumber();
    let _is_initialized = source.readBoolean();
    let _trusted_address = source.readAddressOpt();
...
function storeTupleModule$Data(source: Module$Data) {
    let builder = new TupleBuilder();
    builder.writeAddress(source.collection_address);
...
function dictValueParserModule$Data(): DictionaryValue<Module$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeModule$Data(src)).endCell());
        },
        parse: (src) => {
            return loadModule$Data(src.loadRef().beginParse());
        }
    }
}
...
async function ShipsCollection_init(owner_address: Address, collection_content: Cell, collection_base: Cell, royalty_params: RoyaltyParams, unique_nonce: bigint, TOTAL_SUPPLY: bigint, treasury_address: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
export const ShipsCollection_getterMapping: { [key: string]: string } = {
