...
export type ChangeHighload = {
    $$type: 'ChangeHighload';
    highload_address: Address;
}

export function storeChangeHighload(src: ChangeHighload) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(2316713580, 32);
        b_0.storeAddress(src.highload_address);
    };
}

export function loadChangeHighload(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2316713580) { throw Error('Invalid prefix'); }
    let _highload_address = sc_0.loadAddress();
    return { $$type: 'ChangeHighload' as const, highload_address: _highload_address };
}

function loadTupleChangeHighload(source: TupleReader) {
    let _highload_address = source.readAddress();
    return { $$type: 'ChangeHighload' as const, highload_address: _highload_address };
}

function loadGetterTupleChangeHighload(source: TupleReader) {
    let _highload_address = source.readAddress();
    return { $$type: 'ChangeHighload' as const, highload_address: _highload_address };
}

function storeTupleChangeHighload(source: ChangeHighload) {
    let builder = new TupleBuilder();
    builder.writeAddress(source.highload_address);
    return builder.build();
}

function dictValueParserChangeHighload(): DictionaryValue<ChangeHighload> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeChangeHighload(src)).endCell());
        },
        parse: (src) => {
            return loadChangeHighload(src.loadRef().beginParse());
        }
    }
}
...
export function loadChangeTreasury(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 370798756) { throw Error('Invalid prefix'); }
    let _treasury_address = sc_0.loadAddress();
    return { $$type: 'ChangeTreasury' as const, treasury_address: _treasury_address };
}
...
export function storeSetPause(src: SetPause) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(163970072, 32);
        b_0.storeBit(src.is_pausable);
    };
}

export function loadSetPause(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 163970072) { throw Error('Invalid prefix'); }
    let _is_pausable = sc_0.loadBit();
    return { $$type: 'SetPause' as const, is_pausable: _is_pausable };
}

function loadTupleSetPause(source: TupleReader) {
    let _is_pausable = source.readBoolean();
    return { $$type: 'SetPause' as const, is_pausable: _is_pausable };
}

function loadGetterTupleSetPause(source: TupleReader) {
    let _is_pausable = source.readBoolean();
    return { $$type: 'SetPause' as const, is_pausable: _is_pausable };
}

function storeTupleSetPause(source: SetPause) {
    let builder = new TupleBuilder();
    builder.writeBoolean(source.is_pausable);
    return builder.build();
}

function dictValueParserSetPause(): DictionaryValue<SetPause> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSetPause(src)).endCell());
        },
        parse: (src) => {
            return loadSetPause(src.loadRef().beginParse());
        }
    }
}
...
export type ChangeRoyaltyParams = {
    $$type: 'ChangeRoyaltyParams';
    numerator: bigint;
    denominator: bigint;
    destination: Address;
}

export function storeChangeRoyaltyParams(src: ChangeRoyaltyParams) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(1209124053, 32);
        b_0.storeInt(src.numerator, 257);
        b_0.storeInt(src.denominator, 257);
        b_0.storeAddress(src.destination);
    };
...
export function loadChangeRoyaltyParams(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1209124053) { throw Error('Invalid prefix'); }
    let _numerator = sc_0.loadIntBig(257);
    let _denominator = sc_0.loadIntBig(257);
    let _destination = sc_0.loadAddress();
    return { $$type: 'ChangeRoyaltyParams' as const, numerator: _numerator, denominator: _denominator, destination: _destination };
}

function loadTupleChangeRoyaltyParams(source: TupleReader) {
    let _numerator = source.readBigNumber();
    let _denominator = source.readBigNumber();
    let _destination = source.readAddress();
    return { $$type: 'ChangeRoyaltyParams' as const, numerator: _numerator, denominator: _denominator, destination: _destination };
...
function loadGetterTupleChangeRoyaltyParams(source: TupleReader) {
    let _numerator = source.readBigNumber();
    let _denominator = source.readBigNumber();
    let _destination = source.readAddress();
    return { $$type: 'ChangeRoyaltyParams' as const, numerator: _numerator, denominator: _denominator, destination: _destination };
...
function storeTupleChangeRoyaltyParams(source: ChangeRoyaltyParams) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.numerator);
    builder.writeNumber(source.denominator);
    builder.writeAddress(source.destination);
...
function dictValueParserChangeRoyaltyParams(): DictionaryValue<ChangeRoyaltyParams> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeChangeRoyaltyParams(src)).endCell());
        },
        parse: (src) => {
            return loadChangeRoyaltyParams(src.loadRef().beginParse());
        }
    }
}
...
export function storeShipAssembler$Data(src: ShipAssembler$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeAddress(src.highload_address);
        let b_1 = new Builder();
        b_1.storeInt(src.owner_public_key, 257);
...
export function loadShipAssembler$Data(slice: Slice) {
    ...
    let _highload_address = sc_0.loadAddress();
    let sc_1 = sc_0.loadRef().beginParse();
    let _owner_public_key = sc_1.loadIntBig(257);
    let _nft_counter = sc_1.loadIntBig(257);
    let _collection_metadata = sc_1.loadRef();
    let _nft_item_metadata = sc_1.loadRef();
    let sc_2 = sc_1.loadRef().beginParse();
    let _royalty_params = loadRoyaltyParams(sc_2);
    return { $$type: 'ShipAssembler$Data' as const, is_pausable: _is_pausable, owner_address: _owner_address, treasury_address: _treasury_address, highload_address: _highload_address, owner_public_key: _owner_public_key, nft_counter: _nft_counter, collection_metadata: _collection_metadata, nft_item_metadata: _nft_item_metadata, royalty_params: _royalty_params };
}
...
export function storeShipNFT$Data(src: ShipNFT$Data) {
    return (builder: Builder) => {
        ...
        if (src.ship_level !== null && src.ship_level !== undefined) { b_0.storeBit(true).storeInt(src.ship_level, 257); } else { b_0.storeBit(false); }
        b_0.storeBit(src.is_initialized);
        let b_1 = new Builder();
...
export function loadShipNFT$Data(slice: Slice) {
    ...
    let _ship_level = sc_0.loadBit() ? sc_0.loadIntBig(257) : null;
    let _is_initialized = sc_0.loadBit();
    let sc_1 = sc_0.loadRef().beginParse();
...
function loadTupleShipNFT$Data(source: TupleReader) {
    ...
    let _ship_level = source.readBigNumberOpt();
    let _is_initialized = source.readBoolean();
...
function initShipAssembler_init_args(src: ShipAssembler_init_args) {
    return (builder: Builder) => {
        ...
        let b_2 = new Builder();
        b_2.storeInt(src.owner_public_key, 257);
        b_2.storeRef(src.collection_metadata);
        b_2.storeRef(src.nft_item_metadata);
        b_1.storeRef(b_2.endCell());
        b_0.storeRef(b_1.endCell());
    };
}

async function ShipAssembler_init(owner_address: Address, treasury_address: Address, highload_address: Address, royalty_params: RoyaltyParams, owner_public_key: bigint, collection_metadata: Cell, nft_item_metadata: Cell) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initShipAssembler_init_args({ $$type: 'ShipAssembler_init_args', owner_address, treasury_address, highload_address, royalty_params, owner_public_key, collection_metadata, nft_item_metadata })(builder);
...
const ShipAssembler_errors: { [key: number]: { message: string } } = {
    ...
    1629: { message: `Mint is on pause` },
    27499: { message: `initialized tx need from collection` },
    44837: { message: `Only the owner` },
    46215: { message: `Only owner can change` },
...
const ShipAssembler_types: ABIType[] = [
    ...
    {"name":"ChangeHighload","header":2316713580,"fields":[{"name":"highload_address","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"ChangeTreasury","header":370798756,"fields":[{"name":"treasury_address","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"SetPause","header":163970072,"fields":[{"name":"is_pausable","type":{"kind":"simple","type":"bool","optional":false}}]},
    ...
    {"name":"ChangeRoyaltyParams","header":1209124053,"fields":[{"name":"numerator","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"denominator","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"destination","type":{"kind":"simple","type":"address","optional":false}}]},
    ...
    {"name":"ShipAssembler$Data","header":null,"fields":[{"name":"is_pausable","type":{"kind":"simple","type":"bool","optional":false}},{"name":"owner_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"treasury_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"highload_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"owner_public_key","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"nft_counter","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"collection_metadata","type":{"kind":"simple","type":"cell","optional":false}},{"name":"nft_item_metadata","type":{"kind":"simple","type":"cell","optional":false}},{"name":"royalty_params","type":{"kind":"simple","type":"RoyaltyParams","optional":false}}]},
    {"name":"ShipNFT$Data","header":null,"fields":[{"name":"collection_address","type":{"kind":"simple","type":"address","optional":false}},{"name":"item_index","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"ship_level","type":{"kind":"simple","type":"int","optional":true,"format":257}},{"name":"is_initialized","type":{"kind":"simple","type":"bool","optional":false}},{"name":"trusted_address","type":{"kind":"simple","type":"address","optional":true}},{"name":"owner","type":{"kind":"simple","type":"address","optional":true}},{"name":"individual_content","type":{"kind":"simple","type":"cell","optional":true}}]},
]
...
const ShipAssembler_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"typed","type":"ChangeHighload"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ChangeTreasury"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ChangeRoyaltyParams"}},
    {"receiver":"internal","message":{"kind":"typed","type":"SetPause"}},
...
export class ShipAssembler implements Contract {
    ...
    static async init(owner_address: Address, treasury_address: Address, highload_address: Address, royalty_params: RoyaltyParams, owner_public_key: bigint, collection_metadata: Cell, nft_item_metadata: Cell) {
        return await ShipAssembler_init(owner_address, treasury_address, highload_address, royalty_params, owner_public_key, collection_metadata, nft_item_metadata);
    }
    
    static async fromInit(owner_address: Address, treasury_address: Address, highload_address: Address, royalty_params: RoyaltyParams, owner_public_key: bigint, collection_metadata: Cell, nft_item_metadata: Cell) {
        const init = await ShipAssembler_init(owner_address, treasury_address, highload_address, royalty_params, owner_public_key, collection_metadata, nft_item_metadata);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: AssembleShipMessage | UpgradeShip | MintNFT | UpdatePublicKey | WithdrawFunds | Excesses | ChangeHighload | ChangeTreasury | ChangeRoyaltyParams | SetPause | GetRoyaltyParams | null | Deploy) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ChangeHighload') {
            body = beginCell().store(storeChangeHighload(message)).endCell();
        }
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ChangeRoyaltyParams') {
            body = beginCell().store(storeChangeRoyaltyParams(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetPause') {
            body = beginCell().store(storeSetPause(message)).endCell();
        }
