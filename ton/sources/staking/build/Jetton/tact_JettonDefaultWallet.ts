...
export function loadSetSecondMinter(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1385815344) { throw Error('Invalid prefix'); }
    let _query_id = sc_0.loadUintBig(64);
    let _new_address = sc_0.loadAddress();
    return { $$type: 'SetSecondMinter' as const, query_id: _query_id, new_address: _new_address };
}
...
function loadGetterTupleSetSecondMinter(source: TupleReader) {
    let _query_id = source.readBigNumber();
    let _new_address = source.readAddress();
    return { $$type: 'SetSecondMinter' as const, query_id: _query_id, new_address: _new_address };
}
...
export type MMPROJetton$Data = {
    $$type: 'MMPROJetton$Data';
    totalSupply: bigint;
    owner: Address;
    second_minter: Address;
    content: Cell;
    mintable: boolean;
    max_supply: bigint;
}

export function storeMMPROJetton$Data(src: MMPROJetton$Data) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeCoins(src.totalSupply);
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.second_minter);
...
export function loadMMPROJetton$Data(slice: Slice) {
    let sc_0 = slice;
    let _totalSupply = sc_0.loadCoins();
    let _owner = sc_0.loadAddress();
    let _second_minter = sc_0.loadAddress();
    let _content = sc_0.loadRef();
    let _mintable = sc_0.loadBit();
    let _max_supply = sc_0.loadCoins();
    return { $$type: 'MMPROJetton$Data' as const, totalSupply: _totalSupply, owner: _owner, second_minter: _second_minter, content: _content, mintable: _mintable, max_supply: _max_supply };
}

function loadTupleMMPROJetton$Data(source: TupleReader) {
    let _totalSupply = source.readBigNumber();
    let _owner = source.readAddress();
    let _second_minter = source.readAddress();
...
function loadGetterTupleMMPROJetton$Data(source: TupleReader) {
    let _totalSupply = source.readBigNumber();
    let _owner = source.readAddress();
    let _second_minter = source.readAddress();
    let _content = source.readCell();
...
function storeTupleMMPROJetton$Data(source: MMPROJetton$Data) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.totalSupply);
    builder.writeAddress(source.owner);
    builder.writeAddress(source.second_minter);
...
function dictValueParserMMPROJetton$Data(): DictionaryValue<MMPROJetton$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeMMPROJetton$Data(src)).endCell());
        },
        parse: (src) => {
            return loadMMPROJetton$Data(src.loadRef().beginParse());
        }
    }
}
...
async function JettonDefaultWallet_init(master: Address, owner: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const JettonDefaultWallet_errors: { [key: number]: { message: string } } = {
    ...
    38718: { message: `Not Owner or Second Minter` },
...
const JettonDefaultWallet_types: ABIType[] = [
    ...
    {"name":"Mint","header":21,"fields":[{"name":"query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"receiver","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"SetSecondMinter","header":1385815344,"fields":[{"name":"query_id","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"new_address","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"MMPROJetton$Data","header":null,"fields":[{"name":"totalSupply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"second_minter","type":{"kind":"simple","type":"address","optional":false}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}},{"name":"mintable","type":{"kind":"simple","type":"bool","optional":false}},{"name":"max_supply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
