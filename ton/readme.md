...
3. Необходимо указать секретную фразу кошелька.
   ...
   2.1. Переименовать файл .envExample в .env
...
владелец контракта:
UQDSni3H4D2iR7ZNU7nxWNm0vLFAAyw7XRD9eEnbM2CElNwB
...
Вот коллекция в эксплорере, адрес верный
https://getgems.io/collection/EQB7x_FVrtXqvoHuFRKsjIv1-2gIvc9wamuv48_rnCq8cWTR

Кошелек Святослава
UQAkB5mic0dgAt_h9WT0wZeNImn8FamUnegVnY0aiicjYJCp
